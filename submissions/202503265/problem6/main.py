...
class Precision(Metric):
    ...
    def compute(self, y_true: list[int], y_pred: list[int]) -> float:
        ...
        true_positives = sum(1 for t, p in zip(y_true, y_pred) if t == self.positive_class and p == self.positive_class)
        false_positives = sum(1 for t, p in zip(y_true, y_pred) if t != self.positive_class and p == self.positive_class)
...
class Recall(Metric):
    ...
    def compute(self, y_true: list[int], y_pred: list[int]) -> float:
        ...
        true_positives = sum(1 for t, p in zip(y_true, y_pred) if t == self.positive_class and p == self.positive_class)
        false_negatives = sum(1 for t, p in zip(y_true, y_pred) if t == self.positive_class and p != self.positive_class)
